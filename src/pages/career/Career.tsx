    ...
    <div className='bg-[#f4f7f9] pt-20'>
      <section className='grid w-full grid-cols-2 xl:max-w-[1440px] 3xl:max-w-full'>
        <div className='relative col-span-1 flex h-full w-full flex-col justify-center lg:pl-10 xl:pl-[100px] 3xl:pl-[200px]'>
          <h1 className='z-10 text-nowrap font-semibold text-black xs:text-[56px]/[66px] sm:text-[56px]/[66px] md:text-[56px]/[66px] lg:text-[46px]/[56px] xl:text-[56px]/[66px] 3xl:text-[60px]/[70px]'>
            Empower Your <br />
          ...
          <p className='z-10 mt-6 font-normal tracking-[2%] text-black xs:text-[16px]/[26px] sm:text-[16px]/[26px] md:text-[16px]/[26px] lg:mt-5 lg:text-[15px]/[25px] xl:text-[16px]/[26px] 3xl:mt-8 3xl:text-[18px]/[28px]'>
